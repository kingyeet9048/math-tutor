isTeaching().then((result) => {
    ...
    function deleteCourseT() {
        deleteCourseTeaching({}).then((result) => {
    ...
    function send() {
        modifyCourseTeaching({'courseName': courseInput.value}).then((result) => {
            var alert = document.createElement('div');
            alert.className = "alert alert-success alert-dismissible fade show";
            alert.role = "alert";
            document.getElementById('card').appendChild(alert);
    ...
    function add() {
        addCourseTeaching({'courseName': courseInput.value, 'courseLevel': courseLevelInput.options[courseLevelInput.selectedIndex].value}).then((result) => {
            var alert = document.createElement('div');
            alert.className = "alert alert-success alert-dismissible fade show";
            alert.role = "alert";
            document.getElementById('card').appendChild(alert);
